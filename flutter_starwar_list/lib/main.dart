...
import 'package:flutter_starwar_list/models/people.dart';
import 'package:flutter_starwar_list/models/planet.dart';
            ...
            Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  List<String> urlFotoPerson =
                      personas.elementAt(index).url.split('/');
                  String fotoPerson = urlFotoPerson[5];
                  List<String> urlFotoPlanet =
                      personas.elementAt(index).url.split('/');
                      ...
                      child: Card(
                          ...
                          child: ClipRRect(
                              ...
                              child: Column(children: <Widget>[
                                Image(
                                  image: NetworkImage(
                                      'https://starwars-visualguide.com/assets/img/characters/${fotoPerson}.jpg'),
                                ),
                                Container(
